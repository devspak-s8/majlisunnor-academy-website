...
export function CTASection() {
  ...
  return (
    <section ref={sectionRef} className="py-24 md:py-32 bg-gradient-to-br from-primary via-secondary to-primary">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-xl md:text-2xl text-primary-foreground/90 leading-relaxed max-w-2xl mx-auto" dir="rtl">
            انضم إلى مجتمعنا من المتعلمين المتفانين واكتشف جمال القرآن والعلوم الإسلامية
          </p>
          <p className="text-xl md:text-2xl text-primary-foreground/90 leading-relaxed max-w-2xl mx-auto">
            Join our community of dedicated learners and discover the beauty of Quranic and Islamic sciences
          </p>
